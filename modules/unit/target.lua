DFUI:NewDefaults("Target", {
    enabled = {true},
    targetDarkMode = {0, "slider", {0, 1, 0.1}, nil, "外观", 1, "调整深色模式强度", nil, nil},
    targetColor = {{1, 1, 1}, "colour", nil, nil, "外观", 2, "更改目标颜色", nil, nil},
    frameScale = {1, "slider", {0.7, 1.3, 0.1}, nil, "外观", 3, "调整框架大小", nil, nil},
    textShow = {true, "checkbox", nil, nil, "文字", 4, "显示生命值和法力值文字", nil, nil},
    textMaxShow = {true, "checkbox", nil, "textShow", "文字", 5, "显示最大生命值和法力值文字", nil, nil},
    noPercent = {true, "checkbox", nil, "textShow", "文字", 6, "仅显示当前数值，不显示百分比", nil, nil},
    textColoringHealth = {false, "checkbox", nil, "textShow", "文字", 7, "根据生命值百分比着色文字", nil, nil},
    textColoringResource = {false, "checkbox", nil, "textShow", "文字", 8, "根据资源(法力/怒气/能量)百分比着色文字", nil, nil},
    frameFont = {"FRIZQT__.TTF", "dropdown", {
        ...
        "Continuum",
        "DieDieDie"
    }, nil, "文字", 9, "更改目标框架使用的字体", nil, nil},
    healthSize = {15, "slider", {8, 20, 1}, "textShow", "文字", 10, "生命值文字字体大小", nil, nil},
    manaSize = {9, "slider", {8, 20, 1}, "textShow", "文字", 11, "法力值文字字体大小", nil, nil},
    nameSize = {9, "slider", {6, 16, 1}, nil, "文字", 12, "目标名字文字字体大小", nil, nil},
    levelSize = {9, "slider", {6, 16, 1}, nil, "文字", 13, "目标等级文字字体大小", nil, nil},
    colorReaction = {true, "checkbox", nil, nil, "生命值条", 14, "根据目标反应着色生命值条", nil, nil},
    colorClass = {false, "checkbox", nil, nil, "生命值条", 15, "根据目标职业着色生命值条", nil, nil},
    enablePulse = {true, "checkbox", nil, nil, "生命值条", 16, "启用生命值条脉冲动画", nil, nil},
    pulseColor = {{1, 1, 1}, "colour", nil, "enablePulse", "生命值条", 17, "脉冲动画颜色", nil, nil},
    enableCutout = {true, "checkbox", nil, nil, "生命值条", 18, "启用生命值条切割动画", nil, nil},
    cutoutColor = {{1, 0, 0}, "colour", nil, "enableCutout", "生命值条", 19, "伤害切割效果颜色", nil, nil},
})

DFUI:NewMod("Target", 1, function()
    local configCache = {
        noPercent = nil,
        textMaxShow = nil,
    ...
    callbacks.targetDarkMode = function(value)
        local intensity = DFUI:GetTempDB("Target", "targetDarkMode")
        local targetColor = DFUI:GetTempDB("Target", "targetColor")
    ...
    -- execute callbacks
    DFUI:NewCallbacks("Target", callbacks)
end)
