DFUI:NewDefaults("Target", {
    enabled = {true},
    targetDarkMode = {0, "slider", {0, 1}, nil, "外观", 1, "调整深色模式强度", nil, nil},
    targetColor = {{1, 1, 1}, "colour", nil, nil, "外观", 2, "更改目标颜色", nil, nil},
    frameScale = {1, "slider", {0.7, 1.3}, nil, "外观", 3, "调整框架大小", nil, nil},
    ...
    healthSize = {15, "slider", {8, 20}, "textShow", "文字", 10, "生命值文字字体大小", nil, nil},
    manaSize = {9, "slider", {8, 20}, "textShow", "文字", 11, "法力值文字字体大小", nil, nil},
    nameSize = {9, "slider", {6, 16}, nil, "文字", 12, "目标名字文字字体大小", nil, nil},
    levelSize = {9, "slider", {6, 16}, nil, "文字", 13, "目标等级文字字体大小", nil, nil},
