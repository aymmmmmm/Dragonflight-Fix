DFRL:NewDefaults("Player", {
    enabled = {true},
    playerDarkMode = {0, "slider", {0, 1}, nil, "外观", 1, "调整深色模式强度", nil, nil},
    playerColor = {{1, 1, 1}, "colour", nil, nil, "外观", 2, "更改玩家颜色", nil, nil},
    eliteBorder = {"standard", "dropdown", {"standard", "rare", "elite", "rare-elite", "boss", "dfrl evolved", "dfrl nebula"}, nil, "外观", 3, "更改玩家框架的材质", nil, nil},
    frameScale = {1, "slider", {0.7, 1.3}, nil, "外观", 4, "调整框架大小", nil, nil},
    ...
    healthSize = {15, "slider", {8, 20}, "textShow", "文字", 13, "生命值文字字体大小", nil, nil},
    manaSize = {9, "slider", {8, 20}, "textShow", "文字", 14, "法力值文字字体大小", nil, nil},
    nameSize = {9, "slider", {6, 16}, nil, "文字", 15, "名字文字字体大小", nil, nil},
    levelSize = {9, "slider", {6, 16}, nil, "文字", 16, "等级文字字体大小", nil, nil},
    ...
    glowSpeed = {1, "slider", {0.4, 5}, "combatGlow", "战斗效果", 24, "调整战斗脉冲速度", nil, nil},
    glowAlpha = {1, "slider", {0.1, 1}, "combatGlow", "战斗效果", 25, "调整战斗脉冲最大透明度", nil, nil},
    restingGlow = {true, "checkbox", nil, nil, "休息效果", 26, "启用休息发光动画", nil, nil},
    restingSpeed = {1, "slider", {0.4, 5}, "restingGlow", "休息效果", 27, "调整休息脉冲速度", nil, nil},
    restingAlpha = {1, "slider", {0.1, 1}, "restingGlow", "休息效果", 28, "调整休息脉冲最大透明度", nil, nil},
