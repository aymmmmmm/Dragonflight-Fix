...
DFUI:NewMod("PVPIcon", 1, function()
    local Setup = {
        allianceTexture = "Interface\\AddOns\\Dragonflight-Fix\\media\\tex\\unitframes\\UI-PVP-Alliance",
        hordeTexture = "Interface\\AddOns\\Dragonflight-Fix\\media\\tex\\unitframes\\UI-PVP-Horde"
    }
    ...
    DFUI:NewCallbacks("PVPIcon", callbacks)
end)
