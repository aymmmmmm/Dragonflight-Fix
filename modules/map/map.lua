DFRL:NewDefaults("Map", {
    enabled = {true},
    mapDarkMode = {0, "slider", {0, 1}, nil, "外观", 1, "调整深色模式强度", nil, nil},
    ...
    mapSize = {180, "slider", {140, 350}, nil, "地图基础", 5, "调整小地图的整体大小", "Bug: 设置后移动角色(无法修复)", nil},
    mapAlpha = {1, "slider", {0.1, 1}, nil, "地图基础", 6, "调整整个小地图的透明度", nil, nil},
    mapShadow = {true, "checkbox", nil, nil, "地图阴影", 7, "显示或隐藏小地图内的阴影", nil, nil},
    alphaShadow = {0.3, "slider", {0.1, 1}, nil, "地图阴影", 8, "调整小地图阴影的透明度", nil, nil},
    showZoom = {true, "checkbox", nil, nil, "地图缩放", 9, "显示或隐藏小地图上的缩放按钮", nil, nil},
    scaleZoom = {0.8, "slider", {0.2, 2}, nil, "地图缩放", 10, "调整缩放按钮的大小", nil, nil},
    alphaZoom = {1, "slider", {0.1, 1}, nil, "地图缩放", 11, "调整缩放按钮的透明度", nil, nil},
    zoomX = {-5, "slider", {-100, 100}, nil, "地图缩放", 12, "调整缩放按钮的水平位置", nil, nil},
    zoomY = {40, "slider", {-100, 100}, nil, "地图缩放", 13, "调整缩放按钮的垂直位置", nil, nil},
    showTopPanel = {true, "checkbox", nil, nil, "顶部面板", 14, "显示或隐藏顶部信息面板", nil, nil},
    topPanelWidth = {180, "slider", {100, 600}, nil, "顶部面板", 15, "调整顶部面板的宽度", nil, nil},
    topPanelHeight = {12, "slider", {5, 50}, nil, "顶部面板", 16, "调整顶部面板的高度", nil, nil},
    ...
    zoneTextSize = {10, "slider", {6, 30}, nil, "顶部面板区域", 18, "调整区域文字的字体大小", nil, nil},
    zoneTextY = {-3, "slider", {-50, 50}, nil, "顶部面板区域", 19, "调整区域文字的垂直位置", nil, nil},
    zoneTextX = {4, "slider", {-50, 50}, nil, "顶部面板区域", 20, "调整区域文字的水平位置", nil, nil},
    mapTime = {true, "checkbox", nil, nil, "顶部面板时间", 21, "显示或隐藏小地图上的时间显示", nil, nil},
    timeSize = {10, "slider", {6, 30}, nil, "顶部面板时间", 22, "调整时间显示的字体大小", nil, nil},
    timeY = {-3, "slider", {-50, 50}, nil, "顶部面板时间", 23, "调整时间显示的垂直位置", nil, nil},
    timeX = {-4, "slider", {-50, 50}, nil, "顶部面板时间", 24, "调整时间显示的水平位置", nil, nil},
...
DFRL:NewMod("Map", 1, function()
    ...
    f:SetScript("OnEvent", function()
        ...
        _G.SLASH_DFRLTRACK1 = "/track"
        _G.SlashCmdList["DFRLTRACK"] = function()
            local trackSpells = {}
            ...
            local menuFrame = _G["DFRL_TrackCmdMenu"] or _G.CreateFrame("Frame", "DFRL_TrackCmdMenu", _G.UIParent, "UIDropDownMenuTemplate")
    ...
    -- ============================================================
    -- Independent tracking button (DFRL_TrackBtn)
    -- Completely separate from MiniMapTrackingFrame
    -- ============================================================
    local trackBtnFrame = _G.CreateFrame("Button", "DFRL_TrackBtn", _G.UIParent)
    ...
    local trackMenuFrame = _G.CreateFrame("Frame", "DFRL_TrackBtnMenu", _G.UIParent, "UIDropDownMenuTemplate")
