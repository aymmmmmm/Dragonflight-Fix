DFRL:NewDefaults("Bars", {
    enabled = {true},
    movable = {true},
    barsDarkMode = {0, "slider", {0, 1}, nil, "外观", 1, "调整深色模式强度", nil, nil},
    barsColor = {{1, 1, 1}, "colour", nil, nil, "外观", 2, "更改动作条颜色", nil, nil},
    mainBarBG = {true, "checkbox", nil, nil, "主动作条", 3, "显示或隐藏主动作条背景", nil, nil},
    mainBarScale = {1, "slider", {0.5, 2}, nil, "主动作条", 4, "调整主动作条的缩放", nil, nil},
    mainBarSpacing = {6, "slider", {0, 20}, nil, "主动作条", 5, "调整主动作条按钮间距", nil, nil},
    mainBarAlpha = {1, "slider", {0.1, 1}, nil, "主动作条", 6, "调整主动作条的透明度", nil, nil},
    mainBarGrid = {1, "slider", {1, 6}, nil, "主动作条", 7, "更改主动作条的网格布局", nil, nil},
    ...
    multiBarOneScale = {1, "slider", {0.2, 2}, nil, "多功能条 1", 10, "调整左下动作条的缩放", nil, nil},
    multiBarOneSpacing = {6, "slider", {0.1, 20}, nil, "多功能条 1", 11, "调整左下动作条按钮间距", nil, nil},
    multiBarOneAlpha = {1, "slider", {0.1, 1}, nil, "多功能条 1", 12, "调整左下动作条的透明度", nil, nil},
    multiBarOneGrid = {1, "slider", {1, 6}, nil, "多功能条 1", 13, "更改左下动作条的网格布局", nil, nil},
    multiBarTwoShow = {false, "checkbox", nil, nil, "多功能条 2", 14, "显示或隐藏右下动作条", nil, nil},
    multiBarTwoScale = {1, "slider", {0.2, 2}, nil, "多功能条 2", 15, "调整右下动作条的缩放", nil, nil},
    multiBarTwoSpacing = {6, "slider", {0.1, 20}, nil, "多功能条 2", 16, "调整右下动作条按钮间距", nil, nil},
    multiBarTwoAlpha = {1, "slider", {0.1, 1}, nil, "多功能条 2", 17, "调整右下动作条的透明度", nil, nil},
    multiBarTwoGrid = {1, "slider", {1, 6}, nil, "多功能条 2", 18, "更改右下动作条的网格布局", nil, nil},
    multiBarThreeShow = {false, "checkbox", nil, nil, "多功能条 3", 19, "显示或隐藏左侧动作条", nil, nil},
    multiBarThreeScale = {0.8, "slider", {0.2, 2}, nil, "多功能条 3", 20, "调整左侧动作条的缩放", nil, nil},
    multiBarThreeSpacing = {6, "slider", {0.1, 20}, nil, "多功能条 3", 21, "调整左侧动作条按钮间距", nil, nil},
    multiBarThreeAlpha = {1, "slider", {0.1, 1}, nil, "多功能条 3", 22, "调整左侧动作条的透明度", nil, nil},
    multiBarThreeGrid = {6, "slider", {1, 6}, nil, "多功能条 3", 23, "更改左侧动作条的网格布局", nil, nil},
    multiBarFourShow = {true, "checkbox", nil, nil, "多功能条 4", 24, "显示或隐藏右侧动作条", nil, nil},
    multiBarFourScale = {0.8, "slider", {0.2, 2}, nil, "多功能条 4", 25, "调整右侧动作条的缩放", nil, nil},
    multiBarFourSpacing = {6, "slider", {0.1, 20}, nil, "多功能条 4", 26, "调整右侧动作条按钮间距", nil, nil},
    multiBarFourAlpha = {1, "slider", {0.1, 1}, nil, "多功能条 4", 27, "调整右侧动作条的透明度", nil, nil},
    multiBarFourGrid = {6, "slider", {1, 6}, nil, "多功能条 4", 28, "更改右侧动作条的网格布局", nil, nil},
    ...
    gryphoonScale = {1, "slider", {0.2, 2}, nil, "主动作条装饰", 32, "调整狮鹫/双足飞龙装饰的大小", nil, nil},
    gryphoonX = {-48, "slider", {-200, 200, 3}, nil, "主动作条装饰", 33, "调整狮鹫/双足飞龙装饰的水平位置", nil, nil},
    gryphoonY = {10, "slider", {-200, 200, 3}, nil, "主动作条装饰", 34, "调整狮鹫/双足飞龙装饰的垂直位置", nil, nil},
    gryphoonAlpha = {1, "slider", {0.1, 1}, nil, "主动作条装饰", 35, "调整狮鹫/双足飞龙装饰的透明度", nil, nil},
    ...
    pagingX = {15, "slider", {0, 150}, nil, "主动作条翻页", 38, "调整翻页按钮的水平位置", nil, nil},
    pagingScale = {0.9, "slider", {0.7, 1.8}, nil, "主动作条翻页", 39, "调整翻页按钮的缩放", nil, nil},
    ...
    hotkeyScale = {1.4, "slider", {0.5, 2}, nil, "文字设置", 43, "调整动作按钮上快捷键文字的大小", nil, nil},
    hotkeyX = {0, "slider", {-50, 50}, nil, "文字设置", 44, "调整快捷键文字的水平位置", nil, nil},
    hotkeyY = {-2, "slider", {-50, 50}, nil, "文字设置", 45, "调整快捷键文字的垂直位置", nil, nil},
    ...
    macroScale = {1.3, "slider", {0.5, 2}, nil, "文字设置", 48, "调整动作按钮上宏文字的大小", nil, nil},
    macroX = {0, "slider", {-50, 50}, nil, "文字设置", 49, "调整宏文字的水平位置", nil, nil},
    macroY = {2, "slider", {-50, 50}, nil, "文字设置", 50, "调整宏文字的垂直位置", nil, nil},
    petbarScale = {0.8, "slider", {0.2, 2}, nil, "宠物条", 51, "调整宠物动作条的缩放", nil, nil},
    petbarSpacing = {6, "slider", {0.1, 20}, nil, "宠物条", 52, "调整宠物动作条按钮间距", nil, nil},
    petbarAlpha = {1, "slider", {0.1, 1}, nil, "宠物条", 53, "调整宠物动作条的透明度", nil, nil},
    shapeshiftScale = {0.8, "slider", {0.2, 2}, nil, "变形条", 54, "调整变形条的缩放", nil, nil},
    shapeshiftSpacing = {6, "slider", {0.1, 20}, nil, "变形条", 55, "调整变形按钮间距", nil, nil},
    shapeshiftAlpha = {1, "slider", {0.1, 1}, nil, "变形条", 56, "调整变形条的透明度", nil, nil},
})
