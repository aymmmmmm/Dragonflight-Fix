...
DFUI:NewDefaults("RangeIndicator", {
    enabled = { true },
...
DFUI:NewMod("RangeIndicator", 1, function()
    -- =================
    -- SETUP
    -- =================
    local Setup = {
    ...
    function Setup:CreateIndicatorTexture(button)
        ...
        self.useSimple = DFUI:GetTempDB("RangeIndicator", "indicatorSimple")
        self.useDark = DFUI:GetTempDB("RangeIndicator", "indicatorDark")
    ...
    function Setup:UpdateIndicatorVisibility(button)
        ...
        local alpha = DFUI:GetTempDB("RangeIndicator", "indicatorAlpha")
    ...
    f:SetScript("OnUpdate", function()
        ...
        if updateTimer >= 0.1 then
            Setup:ProcessAllButtons(Setup.UpdateIndicatorVisibility)
            updateTimer = 0
            DFUI.activeScripts["RangeIndicatorScript"] = true
        else
            DFUI.activeScripts["RangeIndicatorScript"] = false
        end
    end)

    DFUI.activeScripts["RangeIndicatorScript"] = false

    DFUI:NewCallbacks("RangeIndicator", callbacks)
end)
