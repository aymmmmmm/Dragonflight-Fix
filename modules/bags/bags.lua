...
DFUI:NewMod("Bags", 1, function()
    ...
    f:SetScript("OnEvent", function()
        ...
        local Setup = {
            texpath = "Interface\\AddOns\\Dragonflight-Fix\\media\\tex\\bags\\",
        ...
        function Setup:MainBag()
            ...
            MainMenuBarBackpackButton:SetScale(DFUI:GetTempDB("Bags", "bagScale"))
        ...
        function Setup:BagToggleButton()
            local bagToggleButton = CreateFrame("Button", "DFUIBagToggleButton", UIParent)
            ...
            DFUI.bagToggleButton = bagToggleButton
            bagToggleButton:SetScript("OnClick", function()
                local currentValue = DFUI:GetTempDB("Bags", "toggleBags")
                DFUI:SetTempDB("Bags", "toggleBags", not currentValue)
            end)
        end
        ...
        function Setup:UpdateKeyRingButtonVisibility()
            ...
            local showBagsValue = DFUI:GetTempDB("Bags", "showBags")
        ...
        callbacks.bagDarkMode = function(value)
            local intensity = DFUI:GetTempDB("Bags", "bagDarkMode")
            local bagColor = DFUI:GetTempDB("Bags", "bagColor")
            ...
            if DFUI.bagToggleButton then
                DFUI.bagToggleButton:GetNormalTexture():SetVertexColor(color[1], color[2], color[3])
                DFUI.bagToggleButton:GetHighlightTexture():SetVertexColor(color[1], color[2], color[3])
                DFUI.bagToggleButton:GetPushedTexture():SetVertexColor(color[1], color[2], color[3])
            end
        ...
        callbacks.bagColor = function(value)
            ...
            if DFUI.bagToggleButton then
                DFUI.bagToggleButton:GetNormalTexture():SetVertexColor(r, g, b)
                DFUI.bagToggleButton:GetHighlightTexture():SetVertexColor(r, g, b)
                DFUI.bagToggleButton:GetPushedTexture():SetVertexColor(r, g, b)
            end
        ...
        callbacks.toggleBags = function(value)
            ...
            local bagHideValue = DFUI:GetTempDB("Bags", "showBags")
            ...
            if value then
                -- normal
                DFUI.bagToggleButton:GetNormalTexture():SetTexCoord(0, 1, 0, 1)
                DFUI.bagToggleButton:GetHighlightTexture():SetTexCoord(0, 1, 0, 1)
                DFUI.bagToggleButton:GetPushedTexture():SetTexCoord(0, 1, 0, 1)
            else
                -- flipped
                DFUI.bagToggleButton:GetNormalTexture():SetTexCoord(1, 0, 0, 1)
                DFUI.bagToggleButton:GetHighlightTexture():SetTexCoord(1, 0, 0, 1)
                DFUI.bagToggleButton:GetPushedTexture():SetTexCoord(1, 0, 0, 1)
            end
        end

        callbacks.bagScale = function(value)
            MainMenuBarBackpackButton:SetScale(value)
            DFUI.bagToggleButton:SetScale(value / 1.8)
        end
        ...
        callbacks.bagAlpha = function(value)
            ...
            DFUI.bagToggleButton:SetAlpha(value)
        end

        callbacks.showBags = function (value)
            if value then
                MainMenuBarBackpackButton:Show()
                DFUI.bagToggleButton:Show()
                ...
                callbacks.bagAlpha(DFUI:GetTempDB("Bags", "bagAlpha"))
            else
        ...
        callbacks.hoverShow = function(value)
            local function SetBagAlpha(alpha)
                ...
                if DFUI.bagToggleButton and DFUI:GetTempDB("Bags", "showToggle") then
                    DFUI.bagToggleButton:SetAlpha(alpha)
                end
            end
            ...
            if value then
                ...
                local function OnEnter()
                    ...
                    if DFUI.bagToggleButton and DFUI:GetTempDB("Bags", "showToggle") then FadeIn(DFUI.bagToggleButton) end
                end
                ...
                local function OnLeave()
                    ...
                    if DFUI.bagToggleButton and DFUI:GetTempDB("Bags", "showToggle") then FadeOut(DFUI.bagToggleButton) end
                end
                ...
                if DFUI.bagToggleButton then
                    DFUI.bagToggleButton:SetScript("OnEnter", OnEnter)
                    DFUI.bagToggleButton:SetScript("OnLeave", OnLeave)
                end
                OnLeave()
            else
                ...
                if DFUI.bagToggleButton then
                    DFUI.bagToggleButton:SetScript("OnEnter", nil)
                    DFUI.bagToggleButton:SetScript("OnLeave", nil)
                end

                callbacks.bagAlpha(DFUI:GetTempDB("Bags", "bagAlpha"))
                callbacks.toggleBags(DFUI:GetTempDB("Bags", "toggleBags"))
            end
        end
        ...
        -- execute callbacks
        DFUI:NewCallbacks("Bags", callbacks)
    end)
end)
