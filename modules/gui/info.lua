...
DFRL:NewMod("Gui-info", 5, function()
    ...
    function Setup:DFInfo()
        if not self.dfinfo then
            ...
            self.grid:AddElement(2, 1, DFRL.tools.CreateCategoryHeader(nil, "龙飞信息"))
            ...
            self.grid:AddElement(1, 7, DFRL.tools.CreateFont(self.dfFrame, self.TEXT_SIZE, "上次更新:", nil, "LEFT"))
            ...
            self.grid:AddElement(1, 8, DFRL.tools.CreateFont(self.dfFrame, self.TEXT_SIZE, "活跃模块:", nil, "LEFT"))
            ...
            self.grid:AddElement(1, 11, DFRL.tools.CreateFont(self.dfFrame, self.TEXT_SIZE, "构建号:", nil, "LEFT"))
...
self.grid:AddElement(6, 8,
    ...
    function Setup:ActiveScripts()
        if not self.scripts then
            ...
            self.grid:AddElement(5, 16 + self.AREA_LINE, DFRL.tools.CreateCategoryHeader(nil, "活跃脚本"))
