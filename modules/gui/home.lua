DFUI:NewDefaults("Gui-home", {
    enabled = {true},

})

DFUI:NewMod("Gui-home", 3, function()
    --=================
    -- SETUP
    --=================
    ...
    function Setup:Logo()
        ...
        Setup.logoText = DFUI.tools.CreateFont(frame, 14, Setup.HOME_TEXTS[1], {1, 1, 1}, "CENTER")
        ...
        Setup.logoTex:SetTexture(DFUI:GetInfoOrCons("tex") .. "gui\\dfui_logo")
        ...
        DFUI.activeScripts["GUI HomeAnimation"] = wasVisible
        ...
        local updateScript = function()
            ...
            if isVisible ~= wasVisible then
                DFUI.activeScripts["GUI HomeAnimation"] = isVisible
        ...
        DFUI.activeScripts["GUI HomeAnimation"] = true
    ...
    function Setup:Lines()
        if DFUI.activeScripts["GUI LinesAnimation"] then return end
        ...
        local done = false
        local wasVisible = Base.mainFrame:IsShown() and Base.selectedTab == 1
        DFUI.activeScripts["GUI LinesAnimation"] = wasVisible
        ...
        local script = function()
            ...
            if isVisible ~= wasVisible then
                DFUI.activeScripts["GUI LinesAnimation"] = isVisible
                wasVisible = isVisible
            end
