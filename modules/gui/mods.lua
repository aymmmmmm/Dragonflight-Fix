...
DFRL:NewMod("Gui-mods", 3, function()
    ...
    function Setup:Modules()
        if not self.init then
            self.descFont = DFRL.tools.CreateFont(panel, self.TEXT_SIZE, "启用或禁用插件模块。更改需要重载UI才能生效。", {0.5, 0.5, 0.5}, "CENTER")
            ...
            self.reloadFont = DFRL.tools.CreateFont(panel, self.TEXT_SIZE, "更改在重载后生效:", {0.5, 0.5, 0.5}, "CENTER")
